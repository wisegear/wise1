...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('epc_staging', function (Blueprint $t) {
            ...
            $t->string('PROPERTY_TYPE', 64)->nullable();
            $t->string('BUILT_FORM', 64)->nullable();
            $t->string('INSPECTION_DATE', 32)->nullable();
            $t->string('LOCAL_AUTHORITY', 32)->nullable();
            $t->string('CONSTITUENCY', 32)->nullable();
            $t->string('COUNTY', 64)->nullable();
            $t->string('LODGEMENT_DATE', 32)->nullable();
            $t->string('TRANSACTION_TYPE', 128)->nullable();
            $t->string('ENVIRONMENTAL_IMPACT_CURRENT', 32)->nullable();
            $t->string('ENVIRONMENTAL_IMPACT_POTENTIAL', 32)->nullable();
            $t->string('ENERGY_CONSUMPTION_CURRENT', 64)->nullable();
            $t->string('ENERGY_CONSUMPTION_POTENTIAL', 64)->nullable();
            $t->string('CO2_EMISSIONS_CURRENT', 64)->nullable();
            $t->string('CO2_EMISS_CURR_PER_FLOOR_AREA', 64)->nullable();
            $t->string('CO2_EMISSIONS_POTENTIAL', 64)->nullable();
            $t->string('LIGHTING_COST_CURRENT', 64)->nullable();
            $t->string('LIGHTING_COST_POTENTIAL', 64)->nullable();
            $t->string('HEATING_COST_CURRENT', 64)->nullable();
            $t->string('HEATING_COST_POTENTIAL', 64)->nullable();
            $t->string('HOT_WATER_COST_CURRENT', 64)->nullable();
            $t->string('HOT_WATER_COST_POTENTIAL', 64)->nullable();
            $t->string('TOTAL_FLOOR_AREA', 64)->nullable();
            $t->string('ENERGY_TARIFF', 64)->nullable();
            ...
            $t->string('MAIN_HEATING_CONTROLS', 128)->nullable();
            $t->string('MULTI_GLAZE_PROPORTION', 32)->nullable();
            $t->string('GLAZED_TYPE', 32)->nullable();
            $t->string('GLAZED_AREA', 32)->nullable();
            ...
            $t->string('MAIN_FUEL', 64)->nullable();
            $t->string('WIND_TURBINE_COUNT', 16)->nullable();
            $t->string('HEAT_LOSS_CORRIDOR', 64)->nullable();
            $t->string('UNHEATED_CORRIDOR_LENGTH', 64)->nullable();
            $t->string('FLOOR_HEIGHT', 64)->nullable();
            $t->string('PHOTO_SUPPLY', 64)->nullable();
            $t->string('SOLAR_WATER_HEATING_FLAG', 8)->nullable();
            $t->string('MECHANICAL_VENTILATION', 64)->nullable();
            $t->text('ADDRESS')->nullable();
            $t->string('LOCAL_AUTHORITY_LABEL', 128)->nullable();
            $t->string('CONSTITUENCY_LABEL', 128)->nullable();
            $t->string('POSTTOWN', 128)->nullable();
            $t->string('CONSTRUCTION_AGE_BAND', 64)->nullable();
            $t->string('LODGEMENT_DATETIME', 32)->nullable();
            $t->string('TENURE', 64)->nullable();
