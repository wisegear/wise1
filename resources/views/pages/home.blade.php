    ...
    <section class="relative overflow-hidden rounded-lg border border-zinc-200 bg-white p-8 shadow-sm flex flex-col md:flex-row justify-between items-center">
        <div class="max-w-5xl relative z-10">
            ...
            <p class="mt-3 text-md leading-7 text-zinc-500">
                Explore sales, repossessions and market signals across England &amp; Wales (some Scotland & NI). Built for clarity, speed and repeatable analysis.  Best on larger screens, some tables are too wide for mobiles. <span class="text-lime-600">Everything on this is site is provided free, no hidden costs, not costs at all.</span>
            </p>
