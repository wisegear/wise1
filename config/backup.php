...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                ...
                'exclude' => [
                    ...
                    storage_path('logs'),
                    storage_path('app/land_registry_csv'),
                    storage_path('app/imports'),
                    storage_path('app/tmp'),
                    public_path('assets/images/uploads/originals'),
                ],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'propertyresearch/',
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_MAIL_TO', 'lee@wisener.net'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'lee@wisener.net'),
                'name' => env('MAIL_FROM_NAME', 'Property Research'),
            ],
        ],
